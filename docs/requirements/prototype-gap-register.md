...
| GAP-09 | Overview/design натякає на різні години працівників | Суперечить SPEC §17.4 | Один clinic-wide schedule; prototype hours — demo text | Clinic + scheduling / TP-206, TP-401 | `tracked`, ADR-002 |
| GAP-10 | Картки показують «Кабінет 1», але prototype не перевіряє room race | Подвійне використання фізичної кімнати | Room catalog, FK/snapshot та DB occupancy constraint | Clinic + scheduling / TP-204, TP-401—402 | `tracked`, ADR-001 |
...
| GAP-17 | Photo demo змінює preview/count; clinic logo читається `FileReader`/data URL | Немає private storage, file validation, progress, cleanup або signed access | Upload-intent/finalize/private-read lifecycle; окремий безпечний logo contract | Visits/clinic + security / TP-204, TP-603, TP-902 | `tracked`, ADR-004 |
