...
| TP-603 | `done` | Private BEFORE/AFTER upload-intent/finalize/read/delete; mobile/tablet choice between rear-camera capture and regular file picker; canonical EXIF-free images; signed role/object access; cleanup/audit; current frontend gate 233 tests; responsive browser evidence |
