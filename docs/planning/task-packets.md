...
ERD та ADR-001—ADR-006 погоджені 2026-07-20; TP-101—TP-103, TP-201—TP-207, TP-301—TP-303, TP-401—TP-404, TP-501—TP-503, TP-601—TP-605, TP-701—TP-704, TP-801—TP-804 і TP-901—TP-904 завершено. TP-904 закрив MVP із `23/23 verified`, full-role UAT, fresh/populated database, dependency/runtime-image audits та production-like release rehearsal; [evidence](../evidence/tp-904/README.md). Наступні зміни належать post-MVP backlog і потребують окремих packet.
