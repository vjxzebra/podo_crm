...
@shared_task(name="apps.booking_requests.tasks.dispatch_telegram_work_item_deliveries")
def dispatch_telegram_work_item_deliveries() -> int:
    return dispatch_due_work_item_telegram_deliveries()
